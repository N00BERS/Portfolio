            ...
            <div className='container mx-auto px-8 md:px-16 lg:px-24'>
                ...
                <div className='flex flex-col md:flex-row items-center md:space-x-12'>
                    <div className='flex-1'>
                        ...
                        <p>I'm here to ask you why ngano sige kag tan'aw og porn .</p>
                        <div className='mb-4 mt-8'>
                            <FaEnvelope className='inline-block text-green-400 mr-2' />
                            <a href="mailto:yourname@example.com" className='hover:underline'>
                                christianrama143@gmail.com
                            </a>
                        </div>
                        <div className='mb-4'>
                            <FaPhone className='inline-block text-green-400 mr-2' />
                            <span>+639229812998</span>
                        </div>
                        <div className='mb-4'>
                            <FaMapMarkedAlt className='inline-block text-green-400 mr-2' />
                            <span>San Roque Banwa Guadalupe Cebu City Philippines 6000</span>
                        </div>
                    </div>
